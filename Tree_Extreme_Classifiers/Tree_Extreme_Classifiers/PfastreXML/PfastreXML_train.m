function PfastreXML_train( trn_X_Xf, trn_X_Y, inv_prop, model_dir, param )
    ...
    cmd = sprintf('PfastreXML_train %s %s %s %s %s', file_trn_X_Xf, file_trn_X_Y, file_inv_prop, model_dir, get_arguments(param));
    if isunix
       cmd = ['./' cmd]; 
    end
